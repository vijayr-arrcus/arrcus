...
bcm_vswitch_cross_connect_t_init(&xc_gports);
xc_gports.port1 = tunnel_term_set.tunnel_id;
xc_gports.flags = BCM_VSWITCH_CROSS_CONNECT_DIRECTIONAL;
print bcm_vswitch_cross_connect_add(unit, &xc_gports);
