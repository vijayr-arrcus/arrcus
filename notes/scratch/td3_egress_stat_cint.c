...
void
flex_stat_setup_egress_stats (int unit, uint32_t egress_if, uint32_t vp, uint32_t value, uint32_t *stat_id)
{
  int rv = 0;
	uint32 mode_id = 0;
	uint32 entry_in = 0;
  uint32_t stat_cnt_id;
	...
	attr_selectors[0].attr_value = bcmStatGroupModeAttrPktTypeUnknownL2UC;
	...
	attr_selectors[1].attr_value = bcmStatGroupModeAttrPktTypeKnownL2UC;
	...
	attr_selectors[3].counter_offset = 3;
	attr_selectors[3].attr = bcmStatGroupModeAttrPktType;
	attr_selectors[3].attr_value = bcmStatGroupModeAttrPktTypeKnownL2MC;

	bcm_stat_group_mode_attr_selector_t_init(&attr_selectors[4]);
	attr_selectors[4].counter_offset = 4;
	attr_selectors[4].attr = bcmStatGroupModeAttrPktType;
	attr_selectors[4].attr_value = bcmStatGroupModeAttrPktTypeUnknownL2MC;

	bcm_stat_group_mode_attr_selector_t_init(&attr_selectors[5]);
	attr_selectors[5].counter_offset = 5;
	attr_selectors[5].attr = bcmStatGroupModeAttrPktType;
	attr_selectors[5].attr_value = bcmStatGroupModeAttrPktTypeKnownL3UC;

	bcm_stat_group_mode_attr_selector_t_init(&attr_selectors[6]);
	attr_selectors[6].counter_offset = 6;
	attr_selectors[6].attr = bcmStatGroupModeAttrPktType;
	attr_selectors[6].attr_value = bcmStatGroupModeAttrPktTypeUnknownL3UC;
